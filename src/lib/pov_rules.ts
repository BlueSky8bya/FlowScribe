 ...
 *
 * 반환값 기준:
 * - supported=true → 생성 진행
 * - supported=false, strategy="disabled_for_current_model" → 생성 차단 권장
 * - supported=false, strategy="allow_with_warning" → 경고와 함께 생성 허용
 *
